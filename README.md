...
<div align="center">
  <h2>"기술의 본질을 파고들어 최적의 효율을 찾아내는 개발자"</h2>
  <p>단순히 동작하는 코드를 넘어, 시스템의 병목을 분석하고 구조적 개선을 통해 비즈니스 가치를 극대화하는 것을 즐깁니다.</p>
</div>
...
<h3 align="center">AI & Data Engineering</h3>
<p align="center">
  ...
  <img src="https://img.shields.io/badge/Azure_STT-0089D6?style=flat-square&logo=microsoftazure&logoColor=white">
</p>
...
### 🤖 [Agentic AI] 자율형 지능형 전문가 에이전트
> **LangGraph 기반의 자율형 도구 선택 서비스**
- **Core:** LangGraph, RAG(FAISS), Azure STT, MiniMAX TTS
- **Achievement:** 비동기 처리 및 요약 노드 최적화
- **Role:** 에이전틱 워크플로우 설계 및 실시간 음성 인터페이스 파이프라인 구축

### 🎭 [Computer Vision] 실시간 감정 인식 대시보드
> **ResNet-50 기반의 단일 얼굴 추적 및 다중 감정 분석 시스템**
- **Core:** PyTorch, ResNet-50, OpenCV
- **Achievement:** 데이터 증강 및 정규화 최적화를 통해 추론 편향 문제 해결
- **Role:** 모델 학습 파이프라인 구축 및 실시간 분석 서버 개발

### 🔍 [Vision/OCR] 한국어 OCR 인식률 최적화 프로젝트
> **PaddleOCR AI 모델을 활용한 문서 데이터 추출 및 정확도 개선**
- **Core:** Python, PaddleOCR, OpenCV
- **Achievement:** 다양한 영수증 환경에서의 한글 인식 정확도 고도화 연구
- **Role:** 이미지 전처리 및 OCR 모델 튜닝, 학습  

<br/>

<h1 align="center">🎓 EDUCATION & ACTIVITY</h1>

### 🏫 Chonnam National University
> **지구환경과학부 지질환경전공 | 소프트웨어공학과 부전공**
- **Period:** 2017.03 - 2023.02
- **Detail:** 2021.07 소프트웨어공학 부전공, 컴퓨터공학 전반의 CS 지식 및 개발 역량 습득

### 🚀 SSAFY (Samsung Software Academy For Youth)
> **삼성 청년 SW 아카데미 10기 수료**
- **Period:** 2023.07 - 2024.06
- **Detail:** 실무 중심의 집중 교육을 통해 알고리즘 및 팀 협업 프로젝트 수행
...
<div align="center">
  <p>
    <b>Email:</b> <a href="mailto:dy6153@naver.com">dy6153@naver.com</a> | <a href="mailto:pewlv7976@gmail.com">pewlv7976@gmail.com</a>
  </p>
  <a href="mailto:dy6153@naver.com"><img src="https://img.shields.io/badge/Naver-03C75A?style=flat-square&logo=naver&logoColor=white"></a>
  <a href="mailto:pewlv7976@gmail.com"><img src="https://img.shields.io/badge/Gmail-D14836?style=flat-square&logo=gmail&logoColor=white"></a>
</div>
...
<div align="right">
  <span>📩 dy6153@naver.com</span><br>
  <span>📩 pewlv7976@gmail.com</span>
</div>
